...
CREATE TABLE IF NOT EXISTS "categories" ("id" integer primary key autoincrement not null, "name" varchar not null unique, "created_at" datetime, "updated_at" datetime);
